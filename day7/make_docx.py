...
table(['경쟁 대안', '강점', '약점 (모닝브루의 기회)'], [
    ['대형 프랜차이즈', '앱 주문·픽업, 브랜드 신뢰', '아침 붐빔·대기, 개성 없음'],
    ['저가 프랜차이즈', '저렴, 빠름', '품질 편차, 정성 부족'],
    ['개인 감성 카페', '인테리어·분위기', '늦은 오픈(11시~), 픽업 없음'],
    ['무인 카페', '24시간, 대기 없음', '품질 낮음, 응대 없음'],
])
heading('2.2 대체재 (카페 밖)', 2)
table(['대체재', '강점', '약점 (모닝브루의 기회)'], [
    ['편의점 원두커피', '초저가, 어디에나', '맛·경험 최저'],
    ['회사 탕비실', '무료', '믹스 품질, 기분전환 안 됨'],
    ['배달 앱 커피', '이동 불필요', '배달비·지연, 식은 커피'],
])
page_break()
